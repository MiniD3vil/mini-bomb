...
def bann_text():
    ...
    logo = """
              oo          oo          dP                           dP       
                                   88                           88       
88d8b.d8b. dP 88d888b. dP          88d888b. .d8888b. 88d8b.d8b. 88d888b. 
88'`88'`88 88 88'  `88 88 88888888 88'  `88 88'  `88 88'`88'`88 88'  `88 
88  88  88 88 88    88 88          88.  .88 88.  .88 88  88  88 88.  .88 
dP  dP  dP dP dP    dP dP          88Y8888' `88888P' dP  dP  dP 88Y8888' 
...
def do_zip_update():
    success = False
    if DEBUG_MODE:
        zip_url = "https://github.com/MiniD3vil/mini-bomb/archive/dev.zip"
        dir_name = "mini-bomb-dev"
    else:
        zip_url = "https://github.com/MiniD3vil/mini-bomb/archive/master.zip"
        dir_name = "mini-bomb-master"
    ...
    if success:
        mesgdcrt.SuccessMessage("mini-bomb was updated to the latest version")
        mesgdcrt.GeneralMessage(
            "Please run the script again to load the latest version")
    else:
        mesgdcrt.FailureMessage("Unable to update mini-bomb.")
        mesgdcrt.WarningMessage(
            "Grab The Latest one From https://github.com/MiniD3vil/mini-bomb.git")
...
def do_git_update():
    ...
    if success:
        ...
        print(
            "git checkout . && "
            "git pull https://github.com/MiniD3vil/mini-bomb.git HEAD")
    sys.exit()
...
def check_for_updates():
    ...
    fver = requests.get(
        "https://raw.githubusercontent.com/MiniD3vil/mini-bomb/master/.version"
    ).text.strip()
    if fver != __VERSION__:
        ...
        mesgdcrt.SuccessMessage("mini-bomb is up-to-date")
        mesgdcrt.GeneralMessage("Starting mini-bomb")


def notifyen():
    try:
        if DEBUG_MODE:
            url = "https://github.com/MiniD3vil/mini-bomb/raw/dev/.notify"
        else:
            url = "https://github.com/MiniD3vil/mini-bomb/raw/master/.notify"
...
def pretty_print(cc, target, success, failed):
    ...
    mesgdcrt.SuccessMessage("mini-bomb was created by MiniD3vil")
...
def selectnode(mode="sms"):
    ...
    try:
        ...
        max_limit = {"sms": 10000, "call": 25, "mail": 200}
        cc, target = "", ""
        if mode in ["sms", "call"]:
...
if sys.version_info[0] != 3:
    mesgdcrt.FailureMessage("mini-bomb will work only in Python v3")
    sys.exit()
...
description = """mini-bomb - Your Friendly Spammer Application

mini-bomb can be used for many purposes which incudes -
\t Exposing the vulnerable APIs over Internet
\t Friendly Spamming
\t Testing Your Spam Detector and more ....

mini-bomb is not intented for malicious uses.
"""

parser = argparse.ArgumentParser(description=description,
                                 epilog='Coded by MiniD3vil !!!')
parser.add_argument("-sms", "--sms", action="store_true",
                    help="start mini-bomb with SMS Bomb mode")
parser.add_argument("-call", "--call", action="store_true",
                    help="start mini-bomb with CALL Bomb mode")
parser.add_argument("-mail", "--mail", action="store_true",
                    help="start mini-bomb with MAIL Bomb mode")
parser.add_argument("-ascii", "--ascii", action="store_true",
                    help="show only characters of standard ASCII set")
parser.add_argument("-u", "--update", action="store_true",
                    help="update mini-bomb")
parser.add_argument("-c", "--contributors", action="store_true",
                    help="show current mini-bomb contributors")
parser.add_argument("-v", "--version", action="store_true",
                    help="show current mini-bomb version")
